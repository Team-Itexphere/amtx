                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="tech_id" name="tech_id">
                        ...
                        @foreach($technicians_all as $technician)
                            <option value="{{ $technician->id }}" {{ $work_order->tech_id == $technician->id ? 'selected' : '' }}>{{ $technician->name }}</option>
                        @endforeach
                    </select> 
                </div>
            </div>
            ...
            <tbody>
                @foreach($work_order->service_calls as $call)
                    <tr>
                        ...
                        <td class="align-middle text-center">{{ $call->comp_date ? $call->created_at->format('m/d/Y') : '' }}</td>
