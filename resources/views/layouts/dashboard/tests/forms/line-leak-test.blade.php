...
<div class="container mt-4">
    ...
    <form class="col-md-11 m-auto" id="test-form" action="{{ isset($_GET['edit']) ? url('/dashboard/tests/add/line-leak-test?edit=') . $_GET['edit'] : url('/dashboard/tests/add/line-leak-test') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mt-4 mb-3 pt-2 pb-0 px-4 rounded" style="border: 2px solid #53884047;">
            ...
            <table id="items-table" style="width: 100%; font-size: 15px;">
                ...
                <tbody>
                    ...
                    <tr class="border border-light-subtle test-item">
                        <td>Test Pressure <br><small>(1 1/2 times working pressure)</small></td>
                    ...
                    <tr class="border border-light-subtle test-item">
                        <td>Initial Cylinder Level (ICL)</td>
                    ...
                    <tr class="border border-light-subtle test-item">
                        <td>Final Cylinder Level (FCL)</td>
                    ...
                    <tr class="border border-light-subtle test-item">
                        <td>Total Test Time <br><small>(30 min. minimum)</small></td>
                    ...
                    <tr class="border border-light-subtle test-item">
                        <td>Conclusion (Pass or Fail)</td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[10][0] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[10][0] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[10][1] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[10][1] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[10][2] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[10][2] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[10][3] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[10][3] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                    </tr>
                    <tr class="border border-light-subtle test-item">
                        <td>Leak Detector Manufacturer</td>
                    ...
                    <tr class="border border-light-subtle test-item">
                        <td>Leak Detector Result <br>(Pass or Fail)</td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[13][0] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[13][0] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[13][1] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[13][1] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[13][2] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[13][2] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                        <td>
                            <select class="form-select test-dt">
                            <option value="">- select -</option>
                            <option value="Pass" {{ $testing && $test[13][3] == 'Pass' ? 'selected' : '' }}>Pass</option>
                            <option value="Fail" {{ $testing && $test[13][3] == 'Fail' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </td>
                    </tr>
                </tbody>
