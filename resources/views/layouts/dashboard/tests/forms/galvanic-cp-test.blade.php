...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <h2>{{ isset($_GET['edit']) ? 'Edit' : 'Add' }} <b>»</b> Galvanic CP Test</h2>
    </div>

    <form class="col-md-11 m-auto" id="test-form" action="{{ isset($_GET['edit']) ? url('/dashboard/tests/add/gcp-test?edit=') . $_GET['edit'] : url('/dashboard/tests/add/gcp-test') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mt-4 mb-3 pt-2 pb-0 px-4 rounded" style="border: 2px solid #53884047;">
                ...
                <tr>
                    <td>
                        <select name="criteria_appli">
                            <option value="1">Structure-to-soil potential more negative than -850 mV with respect to a Cu/CuSO₄ reference electrode with protective current applied (galvanic).</option>
            ...
            <table class="table" style="font-size: 11px; margin-top: -17px; line-height: 14px; text-align: center;">
                ...
                <tr>
                    <td colspan="7" style="font-weight: 700; background: #d9d9d9; width: 48%"><center>GALVANIC CATHODIC PROTECTION SYSTEM SURVEY RESULTS</center></td>
                    <td style="display:none;"></td>
                    <td style="display:none;"></td>
                    <td style="display:none;"></td>
                    <td style="display:none;"></td>
