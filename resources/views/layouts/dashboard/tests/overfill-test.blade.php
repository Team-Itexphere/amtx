...
<body>
    ...
    <h4 style="font-weight: 700; background: black; color: white; padding: 4px; margin-top: 12px;"><center>APPENDIX C-5</center></h4>
    ...
    <table class="table" style="font-size: 11px; margin-top: -17px; line-height: 14px;">
        ...
        <tr>
          <td colspan="7">A “No” to any item in Lines 1-5 indicates a test failure.</td>
        </tr>
        ...
        <tr style="border: none;">
          <td colspan="7" style="border: none;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* Use manufacturer’s suggested procedure for determining if automatic shutoff device will shut off flow at 95% capacity<br>
            &nbsp;&nbsp;* * If a ball float is found to fail the inspection, another method of overfill must be used.<br>
