...
<body>
    <table class="table" style="font-size: 11px; margin-top: -3px; line-height: 14px;">
      ...
      <tr>
        <td colspan="4" style="font-weight: 700; background: #d9d9d9;"><center>REASON SURVEY WAS CONDUCTED (mark only one)</center></td>
      </tr>
      <tr>        
        <td colspan="4" style="font-size: 9px;"><br>Date next cathodic protection survey must be conducted by:</td>
      </tr>
      <tr>
        <td colspan="4" style="font-weight: 700; background: #d9d9d9;"><center>CATHODIC PROTECTION TESTER'S EVALUATION (mark only one)</center></td>
      </tr>
      <tr>        
      ...
      <tr>
        <td colspan="4" style="font-weight: 700; background: #d9d9d9;"><center>CRITERIA APPLICABLE TO EVALUATION (mark all that apply)</center></td>
      </tr>      
      <tr>
        <td colspan="4" style="color: transparent;">-</td>
      </tr>
      <tr>
        <td colspan="4" style="font-weight: 700; background: #d9d9d9;"><center>ACTION REQUIRED AS A RESULT OF THIS EVALUATION (mark only one)</center></td>
      </tr>
      <tr>
        <td colspan="4" style="color: transparent;">-</td>
      </tr>
    ...
    <table class="table" style="font-size: 11px; margin-top: -17px; line-height: 14px; text-align: center;">
        ...
        <tr style="font-size: 8px;">
          ...
          <td colspan="3"><b>Rectifier Serial Number:</b></td>
        </tr>
        <tr style="font-size: 8px;">
          <td colspan="2" style="text-align: left;"><b>Rectifier Model:</b></td>
          <td colspan="2" style="color: transparent;">-</td>
          <td colspan="4"><b>Rated DC Output:</b></td>
        </tr>
        <tr>
