    ...
    <div class="modal-content p-3">
      ...
      <div class="modal-body">
        <form id="li-ad" action="{{ url('/dashboard/customers/licenses/add') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="name" class="form-label">License Name <span class="text-danger">*</span></label>
    ...
    <div class="modal-content p-3">
      ...
      <div class="modal-body">
        ...
        @csrf
          ...
          <div class="mb-3">
            <label for="nw_name" class="form-label">License Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control" id="nw_name" name="nw_name" required>
          </div>
          <div class="mb-3">
            <label for="nw_type" class="form-label">License Type</label>
            <input type="text" class="form-control" id="nw_type" name="nw_type">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="nw_agency" class="form-label">Agency</label>
            <input type="text" class="form-control" id="nw_agency" name="nw_agency">
          </div>
          <div class="mb-3">
...
<script>
    ...
    $(document).on('click', '.li-edit-button', function() {
        ...
        var nw_agency = tr.find('td:eq(2)').text();
        var nw_expire_date = tr.find('td:eq(3)').text();
