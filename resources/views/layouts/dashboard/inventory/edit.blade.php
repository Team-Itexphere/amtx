    ...
    <form class="col-md-11 m-auto" action="{{ url('/dashboard/inventory/edit') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="description" name="description" value="{{ $inventory->description }}" required>
            </div> 
            <div class="col-md-6">
                <label for="qty" class="form-label">QTY <span class="text-danger">*</span></label>
                <input type="number" class="form-control" id="qty" name="qty" value="{{ $inventory->qty }}" required>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
