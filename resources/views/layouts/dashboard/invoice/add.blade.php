...
<div class="container mt-4">
    ...
    <form class="col-md-11 m-auto" id="inv-form" action="{{ url('/dashboard/invoice/add') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex">
                    <div class="form-check me-4 mt-1">
                        <input class="form-check-input" type="radio" name="payment" id="paid" value="Paid" required checked>
                        <label class="form-check-label" for="paid">Paid</label>
                    </div>
                    <div class="form-check mt-1">
                        <input class="form-check-input" type="radio" name="payment" id="unpaid" value="Unpaid" required>
        ...
        <div class="mt-5 mb-3 pt-2 pb-0 px-4 rounded" style="border: 2px solid #53884047;">
            ...
            <input type="hidden" id="invoice_items" name="items" value="">
        </div>
        
        <div class="row mb-3">
            <div class="col-md-12">
                <label for="addi_comments" class="form-label">Comments</label>
                <textarea class="form-control" id="addi_comments" name="addi_comments"></textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <button type="button" id="frm_submit" class="btn btn-primary mt-2">Create</button>
            </div>
            <div class="col-md-6">
...
<script>
    ...
    function update_total(){
        ...
        var total_paid = $('#paid_amount').val() ? +$('#paid_amount').val() : 0;
        ...
        $('#total').text((sub_total + sub_tax).toFixed(2));
        $('#total-paid').html(total_paid.toFixed(2));
        $('#paid-date').text(paid_date);
        $('#balance-due').text((sub_total + sub_tax - total_paid).toFixed(2));
